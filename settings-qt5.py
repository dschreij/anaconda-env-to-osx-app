...
CONDA_ENV_PATH = "~/anaconda/envs/opensesame-qt5"
...
def extra():
	...
	# Copy the sdl libraries and remap their linked paths
	copy_sdl_libraries()
	# Correct the linked libraries of the pygame modules to the ones contained
	# in the app
